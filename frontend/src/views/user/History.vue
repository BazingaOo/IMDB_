<template>
  <Layout class="history" :has_menu="false" :has_footer="false" title="Watch History">
    <div class="menu" slot="bar_menu" >
      <mu-menu-item title="Clear History" @click="clearHistory" />
    </div>
    <div class="page_wrap">
      <div class="page_bd">
        ...
        <div class="empty" v-if="!list.length">No View History...</div>
      </div>
    </div>
  </Layout>
</template>
